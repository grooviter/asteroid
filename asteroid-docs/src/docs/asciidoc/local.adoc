...
classes should always extend `asteroid.local.AbstractLocalTransformation` class.
...
needed to implement an instance of `asteroid.local.AbstractLocalTransformation`.
