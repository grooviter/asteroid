...
public final class ChecksBuilder {
     ...
     * @since 0.1.0
     */
    public ChecksBuilder checkTrue(final AnnotationNode node, Boolean expression, String message) {
     ...
     *
     * @param node an instance of {@link AnnotatedNode}
     * @param expression to evaluate{@link AnnotatedNode}
     * @return the current instance
     * @since 0.1.2
     */
    public ChecksBuilder checkTrue(final AnnotatedNode node, Boolean expression, String message) {
        processResult(new Result(node, expression ? Result.Status.PASSED : Result.Status.ERROR, message), sourceUnit);
        return this;
    }
